...
<body class="hold-transition skin-blue sidebar-mini <#if cookieMap?exists && "off" == cookieMap["timingjob_adminlte_settings"].value >sidebar-collapse</#if>">
<div class="wrapper">
	<!-- header -->
                        ...
                        <div class="col-sm-4">
                            <select class="form-control" name="executorFailStrategy" >
								<#list ExecutorFailStrategyEnum as item>
									<option value="${item}" >${item.titile}</option>
								</#list>
                            </select>
						</div>
                    </div>
...
package com.timing.job.service.handler;

import com.timing.job.core.log.XxlJobLogger;
import com.timing.job.core.biz.model.ReturnT;
import com.timing.job.core.handler.IJobHandler;

public class DemoGlueJobHandler extends IJobHandler {

	@Override
	public ReturnT<String> execute(String... params) throws Exception {
		TimingLogger.log("timing -JOB, Hello World.");
